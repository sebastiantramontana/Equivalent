...
namespace EntitiesTests
{
   public class BranchTest
   {
      ...
      public void SubstractIngredientFromEmptyStockTest()
      {
         var branch = Branches.Branch1;
         branch.Warehouse = Warehouses.Warehouse1;
         branch.Warehouse.AddToStock(RawMaterials.Sugar.Instance, Measures.Unit.Instance, 20.0);
      ...
      [Fact]
      public void AddIngredientToStockEmptyAnotherReasonTest()
      {
         var branch = Branches.Branch1;
         branch.Warehouse = Warehouses.Warehouse1;

         Action act = () => branch.AddIngredientToStock(RawMaterials.Sugar.Instance, Measures.Kg.Instance, 6.0, string.Empty);

         Assert.Throws<BusinessException>(act);
      }

      [Fact]
      public void SubstractIngredientFromStockNullAnotherReasonTest()
      {
         var branch = Branches.Branch1;
         branch.Warehouse = Warehouses.Warehouse1;

         Action act = () => branch.SubstractIngredientFromStock(RawMaterials.Sugar.Instance, Measures.Kg.Instance, 2.0, null);
